...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "tools.instagramAccountValueCalculator",
  });
  ...
  return buildRankingMetadata({
    ...
    path: "/tools/instagram-account-value-calculator",
  });
}

export default async function InstagramAccountValueCalculatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("tools.instagramAccountValueCalculator");
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <ValueCalculatorClient platformFilter="instagram" />
