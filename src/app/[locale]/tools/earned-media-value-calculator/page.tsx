...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "tools.earnedMediaValueCalculator",
  });
  ...
  return buildRankingMetadata({
    ...
    path: "/tools/earned-media-value-calculator",
  });
}

export default async function EarnedMediaValueCalculatorPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("tools.earnedMediaValueCalculator");
